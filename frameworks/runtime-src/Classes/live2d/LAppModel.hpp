...
#include "Framework/src/Model/CubismUserModel.hpp"
#include "Framework/src/ICubismModelSetting.hpp"
#include "Framework/src/Type/csmRectF.hpp"
...
private:
    ...
    */
	...
	Csm::csmInt32 m_curMotionId;//当前播放的motionid
};
